...
:root{--bg:#0d0e1a;--card:rgba(10,22,40,0.9);--accent:#7C5CFF;--text:#E8F4FF;--dim:#3D6B8E;--mid:#7BAED4;--border:rgba(124,92,255,0.2)}
...
.bg{position:fixed;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 0%,rgba(124,92,255,0.1),transparent 70%),var(--bg);z-index:0}
.grid{position:fixed;inset:0;background-image:linear-gradient(rgba(124,92,255,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(124,92,255,0.04) 1px,transparent 1px);background-size:44px 44px;z-index:0}
.orb{position:fixed;border-radius:50%;filter:blur(90px);z-index:0;animation:fl 9s ease-in-out infinite}
.o1{width:380px;height:380px;background:rgba(124,92,255,0.07);top:-100px;right:-80px}
.o2{width:280px;height:280px;background:rgba(124,92,255,0.04);bottom:-60px;left:-60px;animation-delay:4s}
...
.card{background:var(--card);border:1px solid var(--border);border-radius:20px;padding:38px 34px 34px;backdrop-filter:blur(24px);box-shadow:0 0 80px rgba(124,92,255,0.07),0 20px 60px rgba(0,0,0,.5)}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:28px}
.brand-img{width:48px;height:48px;border-radius:50%;overflow:hidden;border:1px solid var(--border);box-shadow:0 0 20px rgba(34,211,238,0.35),0 0 12px rgba(124,92,255,0.3);flex-shrink:0}
...
.hint{display:flex;align-items:center;gap:10px;background:rgba(124,92,255,0.07);border:1px solid rgba(124,92,255,0.15);border-radius:10px;padding:10px 14px;margin-bottom:20px}
.hint-label{font-size:11px;color:var(--dim);flex:1}
.hint-val{font-family:ui-monospace,monospace;font-size:14px;font-weight:700;color:var(--accent);background:rgba(124,92,255,0.1);border:1px solid rgba(124,92,255,0.25);padding:3px 11px;border-radius:7px;cursor:pointer;transition:.15s;letter-spacing:.08em}
.hint-val:hover{background:rgba(124,92,255,0.22)}
...
input[type=password]:focus{border-color:rgba(124,92,255,.55);background:rgba(0,0,0,.4);box-shadow:0 0 0 3px rgba(124,92,255,.1)}
...
.btn{width:100%;padding:13px;border-radius:11px;border:none;cursor:pointer;background:linear-gradient(135deg,#7C5CFF,#22D3EE);color:#fff;font-family:inherit;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 4px 20px rgba(34,211,238,.35);transition:.2s;position:relative;overflow:hidden}
...
<div class="wrap">
  <div class="card">
    ...
    <div class="footer">پشتیبانی <a href="https://t.me/YOUR_SUPPORT" target="_blank"><i class="ti ti-brand-telegram"></i>پشتیبانی</a></div>
  </div>
</div>
<script>
...
*{margin:0;padding:0;box-sizing:border-box}
:root{
  --bg:#0d0e1a;--bg2:#14162b;--bg3:#191c38;
  --card:#14162b;--card-b:rgba(124,92,255,0.13);--card-bh:rgba(124,92,255,0.28);
  --accent:#7C5CFF;--accent2:#22D3EE;--accent-d:rgba(124,92,255,0.12);
  --green:#10B981;--green-bg:rgba(124,92,255,0.1);--green-t:#34D399;
  --red:#EF4444;--red-bg:rgba(239,68,68,0.1);--red-t:#F87171;
  --amber:#F59E0B;--amber-bg:rgba(245,158,11,0.1);--amber-t:#FCD34D;
  --purple:#22D3EE;--purple-bg:rgba(34,211,238,0.1);
...
[data-theme="light"]{
  ...
  --card:#FFFFFF;--card-b:rgba(124,92,255,0.15);--card-bh:rgba(124,92,255,0.35);
  --accent:#6D28D9;--accent2:#0E7490;--accent-d:rgba(109,40,217,0.08);
...
.logo-img{width:38px;height:38px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(34,211,238,.3),0 0 8px rgba(124,92,255,.25);flex-shrink:0}
...
.nav-badge{margin-right:auto;background:rgba(124,92,255,0.15);color:var(--accent2);font-size:9px;padding:1px 6px;border-radius:20px;font-weight:700}
...
.mob-logo{width:28px;height:28px;border-radius:50%;overflow:hidden;box-shadow:0 0 8px rgba(34,211,238,.35)}
...
.traf-range-tab.on{background:var(--accent);color:#fff;box-shadow:0 2px 8px rgba(124,92,255,.35)}
...
.btn-p{background:linear-gradient(135deg,#7C5CFF,#22D3EE);color:#fff;box-shadow:0 2px 14px rgba(34,211,238,.35)}
.btn-p:hover{background:#6D28D9;box-shadow:0 4px 18px rgba(124,92,255,.4)}
.btn-o{background:transparent;border:1px solid var(--card-b);color:var(--t2)}
.btn-o:hover{background:var(--accent-d);border-color:rgba(124,92,255,.3)}
.btn-g{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(124,92,255,.15)}
.btn-g:hover{background:rgba(124,92,255,.22)}
.btn-d{background:var(--red-bg);color:var(--red-t);border:1px solid rgba(239,68,68,.2)}
.btn-d:hover{background:rgba(239,68,68,.2)}
.btn-pur{background:var(--purple-bg);color:#A78BFA;border:1px solid rgba(34,211,238,.2)}
.btn-pur:hover{background:rgba(34,211,238,.22)}
...
.sr{display:flex;align-items:center;justify-content:space-between;padding:9px 0;border-bottom:1px solid rgba(124,92,255,0.05);font-size:12px}
...
.fi:focus,.fs:focus{border-color:rgba(124,92,255,.45);background:rgba(0,0,0,.25);box-shadow:0 0 0 3px rgba(124,92,255,.08)}
.fs option{background:var(--bg2)}
[data-theme="light"] .fs option{background:#fff}
.cl{background:var(--accent-d);border:1px solid rgba(124,92,255,.15);border-radius:10px;padding:11px 13px;font-size:11px;color:var(--t2);display:flex;gap:9px;align-items:flex-start;line-height:1.8;margin-top:12px}
...
.cp-head-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 18px rgba(124,92,255,.35)}
...
.cp-input-full:focus{border-color:rgba(124,92,255,.5);box-shadow:0 0 0 3px rgba(124,92,255,.1)}
...
.chip:hover{background:rgba(124,92,255,.18);color:var(--accent2)}
.chip.active{background:var(--accent);color:#fff;border-color:var(--accent);box-shadow:0 3px 10px rgba(124,92,255,.35)}
...
.proto-card.active{border-color:var(--accent);background:var(--accent-d);box-shadow:0 0 0 3px rgba(124,92,255,.1)}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(124,92,255,.35)}
...
.pw-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(34,211,238,.35)}
...
.pw-input:focus{border-color:rgba(34,211,238,.5);box-shadow:0 0 0 3px rgba(34,211,238,.1)}
...
.pw-submit{width:100%;justify-content:center;background:linear-gradient(135deg,var(--purple),#6D48D6);color:#fff;border:none;border-radius:12px;padding:12px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 18px rgba(34,211,238,.32);transition:.18s}
.pw-submit:hover{transform:translateY(-2px);box-shadow:0 10px 24px rgba(34,211,238,.42)}
...
.conn-live-badge{display:flex;align-items:center;gap:6px;font-size:10.5px;font-weight:700;color:var(--green-t);background:var(--green-bg);padding:5px 12px;border-radius:20px;border:1px solid rgba(124,92,255,.2)}
...
.conn-card-v2-glow{position:absolute;top:-40px;left:-40px;width:140px;height:140px;background:radial-gradient(circle,rgba(124,92,255,.1),transparent 70%);pointer-events:none}
.conn-card-v2-top{display:flex;align-items:center;gap:12px;padding:16px 17px 13px;position:relative;z-index:1}
.conn-avatar{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,var(--green),#0D9668);display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;flex-shrink:0;position:relative;box-shadow:0 4px 14px rgba(124,92,255,.3)}
...
.sub-box{background:rgba(34,211,238,.07);border:1px solid rgba(34,211,238,.2);border-radius:10px;padding:14px 16px;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-top:11px}
...
.subs-search input:focus{border-color:rgba(34,211,238,.5);box-shadow:0 0 0 3px rgba(34,211,238,.1)}
...
.sub-card-top::before{content:'';position:absolute;top:-30px;left:-30px;width:130px;height:130px;background:radial-gradient(circle,rgba(34,211,238,.14),transparent 70%);pointer-events:none}
.sub-card-head-v2{display:flex;align-items:flex-start;gap:13px;position:relative;z-index:1}
.sub-card-icon{width:46px;height:46px;border-radius:14px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 16px rgba(34,211,238,.35)}
...
.sub-card-url-row{margin:14px 20px 0;background:rgba(34,211,238,.08);border:1px dashed rgba(34,211,238,.25);border-radius:11px;padding:9px 12px;display:flex;align-items:center;gap:8px}
...
.modal-v2-head{background:linear-gradient(155deg,rgba(34,211,238,.14) 0%,transparent 65%);padding:18px 22px 14px;position:relative;overflow:hidden}
.modal-v2-head::before{content:'';position:absolute;top:-50px;left:-50px;width:160px;height:160px;background:radial-gradient(circle,rgba(34,211,238,.2),transparent 70%);pointer-events:none}
...
.modal-v2-icon{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;margin-bottom:10px;position:relative;z-index:1;box-shadow:0 8px 18px rgba(34,211,238,.4)}
...
.modal-v2-input:focus{border-color:rgba(34,211,238,.55);box-shadow:0 0 0 3px rgba(34,211,238,.12);background:rgba(0,0,0,.28)}
[data-theme="light"] .modal-v2-input:focus{background:#fff}
.modal-v2-input:focus~i{color:var(--purple)}
.modal-v2-hint{background:rgba(124,92,255,.08);border:1px solid rgba(124,92,255,.18);border-radius:11px;padding:9px 12px;font-size:10px;color:var(--t2);display:flex;gap:7px;align-items:flex-start;line-height:1.6;margin-top:2px}
...
.modal-v2-btn-submit{flex:1;justify-content:center;padding:10px;border-radius:11px;background:linear-gradient(135deg,var(--purple),#6D48D6);color:#fff;border:none;font-family:inherit;font-size:12px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;box-shadow:0 6px 18px rgba(34,211,238,.4);transition:.18s}
.modal-v2-btn-submit:hover{transform:translateY(-2px);box-shadow:0 10px 24px rgba(34,211,238,.5)}
...
.lmodal-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;flex-shrink:0;box-shadow:0 6px 16px rgba(124,92,255,.35)}
...
.lmodal-search input:focus{border-color:rgba(124,92,255,.5);box-shadow:0 0 0 3px rgba(124,92,255,.1)}
...
.lmodal-qbtn:hover{background:rgba(124,92,255,.2)}
...
.lrow-v2.checked{background:rgba(124,92,255,.1);border-color:rgba(124,92,255,.25)}
...
.lrow{display:flex;align-items:center;gap:8px;padding:7px 0;border-bottom:1px solid rgba(124,92,255,.05)}
...
.toast.ok{border-color:rgba(124,92,255,.3);background:var(--green-bg);color:var(--green-t)}
...
.cfg-uuid-mini:hover{background:rgba(124,92,255,.2)}
...
.ubar{height:5px;border-radius:4px;background:rgba(124,92,255,0.1);overflow:hidden}
...
.log-item{display:flex;gap:12px;padding:11px 0;border-bottom:1px solid rgba(124,92,255,.05);position:relative}
...
.erow{padding:9px 0;border-bottom:1px solid rgba(124,92,255,.05)}
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    ...
    <a class="df-link" href="https://t.me/YOUR_SUPPORT" target="_blank"><i class="ti ti-brand-telegram"></i> t.me/YOUR_SUPPORT</a>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    ...
    <div class="srv-tiles">
      <a class="srv-tile" href="https://t.me/YOUR_SUPPORT" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-youtube"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">یوتیوب</div><div class="srv-tile-val">t.me/YOUR_SUPPORT</div></div>
      </a>
      ...
      <a class="srv-tile" href="https://t.me/YOUR_SUPPORT" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">کانال تلگرام</div><div class="srv-tile-val">t.me/YOUR_SUPPORT</div></div>
      </a>
...
async function openLinkChart(uuid,label){
  ...
  try{
    ...
    linkChart=new Chart(ctx,{type:'bar',data:{labels,datasets:[{label:'مصرف (MB)',data:vals,backgroundColor:'rgba(34,211,238,.55)',borderRadius:5,maxBarThickness:22}]},
...
function checkPwStrength(val){
  ...
  const colors=['#EF4444','#F59E0B','#7C5CFF','#10B981'],labels=['خیلی ضعیف','ضعیف','متوسط','قوی'];
...
function initCharts(){
  ...
  const grad1=makeGradient(c1,'rgba(124,92,255,.38)','rgba(124,92,255,0)');
  const opts={
    ...
    plugins:{
      ...
      tooltip:{
        backgroundColor:'rgba(13,27,46,.96)',borderColor:'rgba(124,92,255,.3)',borderWidth:1,
    ...
    scales:{
      ...
      y:{grid:{color:'rgba(124,92,255,.06)'},border:{display:false},ticks:{color:'#3D6B8E',font:{size:9,family:'Vazirmatn'},callback:v=>v+' MB'}}
    },
    elements:{line:{capBezierPoints:true}}
  };
  const ds1={label:'MB',data:[],borderColor:'#7C5CFF',backgroundColor:grad1,fill:true,tension:.42,pointRadius:0,pointHoverRadius:6,pointHoverBackgroundColor:'#7C5CFF',pointHoverBorderColor:'#fff',pointHoverBorderWidth:2,borderWidth:2.5};
  ...
  const gradFill3=makeGradientV2(c3ctx,'rgba(124,92,255,.45)','rgba(124,92,255,.08)','rgba(124,92,255,0)');
  ch3=new Chart(document.getElementById('ch3'),{
    type:'line',
    data:{labels:[],datasets:[
      {label:'مصرف',data:[],borderColor:'#7C5CFF',backgroundColor:gradFill3,fill:true,tension:.45,pointRadius:0,pointHoverRadius:7,pointHoverBackgroundColor:'#fff',pointHoverBorderColor:'#7C5CFF',pointHoverBorderWidth:3,borderWidth:3,order:2},
    ...
    options:{
      ...
      plugins:{
        legend:{display:false},
        tooltip:{
          backgroundColor:'rgba(13,27,46,.97)',borderColor:'rgba(124,92,255,.35)',borderWidth:1,
      ...
      scales:{
        ...
        y:{grid:{color:'rgba(124,92,255,.05)'},border:{display:false},ticks:{color:'#3D6B8E',font:{size:9.5,family:'Vazirmatn'},callback:v=>v+' MB'}}
      }
    }
  });
  ...
  ch2=new Chart(document.getElementById('ch2'),{
    ...
    data:{labels:['VLESS/WS','XHTTP Ultra','HTTP Proxy'],datasets:[{
      data:[55,35,10],
      backgroundColor:['#7C5CFF','#10B981','#22D3EE'],
      borderColor:getComputedStyle(document.documentElement).getPropertyValue('--card')||'#14162b',
    ...
    options:{
      ...
      plugins:{
        ...
        tooltip:{backgroundColor:'rgba(13,27,46,.96)',borderColor:'rgba(124,92,255,.3)',borderWidth:1,padding:10,cornerRadius:10,bodyFont:{family:'Vazirmatn'},titleFont:{family:'Vazirmatn'}}
      }
    }
  });
}
...
:root{{
  --bg:#0d0e1a;--bg2:#14162b;--bg3:#191c38;
  --card:#14162b;--card-b:rgba(124,92,255,0.12);--card-bh:rgba(124,92,255,0.28);
  --accent:#7C5CFF;--accent2:#22D3EE;--accent-d:rgba(124,92,255,0.1);
...
[data-theme="light"]{{
  ...
  --card:#FFFFFF;--card-b:rgba(124,92,255,0.14);--card-bh:rgba(124,92,255,0.32);
  --accent:#6D28D9;--accent2:#0E7490;--accent-d:rgba(109,40,217,0.08);
...
.bg-fx{{position:fixed;inset:0;background:radial-gradient(ellipse 70% 45% at 50% -8%,rgba(124,92,255,0.13),transparent 62%),var(--bg);z-index:0;pointer-events:none;transition:background .35s}}
.grid-fx{{position:fixed;inset:0;background-image:linear-gradient(rgba(124,92,255,0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(124,92,255,0.025) 1px,transparent 1px);background-size:46px 46px;z-index:0;pointer-events:none}}
...
.brand-img{{width:40px;height:40px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(34,211,238,.3),0 0 8px rgba(124,92,255,.25);flex-shrink:0}}
.brand-img img{{width:100%;height:100%;object-fit:cover}}
...
.sub-info::before{{content:'';position:absolute;top:0;right:0;width:160px;height:160px;background:radial-gradient(circle at top right,rgba(124,92,255,.1),transparent 70%);pointer-events:none}}
...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,var(--accent) 0%,#2952C8 100%);border-radius:18px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(124,92,255,.28);flex-wrap:wrap}}
...
.ubar{{height:6px;border-radius:4px;background:rgba(124,92,255,0.1);overflow:hidden;margin-bottom:5px}}
...
.btn i{{font-size:13px}}
.btn-p{{background:linear-gradient(135deg,#7C5CFF,#22D3EE);color:#fff;box-shadow:0 3px 14px rgba(34,211,238,.35)}}
.btn-p:hover{{background:var(--accent2)}}
.btn-g{{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(124,92,255,.16)}}
.btn-g:hover{{background:rgba(124,92,255,.2)}}
...
.lock-banner{{background:linear-gradient(150deg,rgba(124,92,255,.16),rgba(124,92,255,.02) 70%);padding:38px 30px 26px;position:relative}}
...
<div class="wrap">
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/YOUR_SUPPORT" target="_blank">پشتیبانی</a> · Matix Panel</div>
</div>
<script>
